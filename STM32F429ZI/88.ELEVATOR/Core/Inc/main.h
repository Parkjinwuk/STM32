...
#define FND0_GPIO_Port GPIOF
#define FND1_Pin GPIO_PIN_1
#define FND1_GPIO_Port GPIOF
#define FND2_Pin GPIO_PIN_2
#define FND2_GPIO_Port GPIOF
#define FND3_Pin GPIO_PIN_3
#define FND3_GPIO_Port GPIOF
#define FND4_Pin GPIO_PIN_4
#define FND4_GPIO_Port GPIOF
#define FND5_Pin GPIO_PIN_5
#define FND5_GPIO_Port GPIOF
#define FND6_Pin GPIO_PIN_7
#define FND6_GPIO_Port GPIOF
#define FND7_Pin GPIO_PIN_8
#define FND7_GPIO_Port GPIOF
