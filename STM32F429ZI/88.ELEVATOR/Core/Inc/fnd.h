...
#define FND_DATA_PORT GPIOF   // data port
#define FND_COM_PORT  GPIOC   // data port

#define FND_a  GPIO_PIN_5
#define FND_b  GPIO_PIN_4
#define FND_c  GPIO_PIN_2
#define FND_d  GPIO_PIN_1
#define FND_e  GPIO_PIN_0
#define FND_f  GPIO_PIN_7
#define FND_g  GPIO_PIN_8
#define FND_p  GPIO_PIN_3
/*
