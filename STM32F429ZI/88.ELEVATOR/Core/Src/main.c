...
/* Definitions for stepmotor_task */
osThreadId_t stepmotor_taskHandle;
const osThreadAttr_t stepmotor_task_attributes = {
  .name = "stepmotor_task",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for fnd_task */
osThreadId_t fnd_taskHandle;
const osThreadAttr_t fnd_task_attributes = {
  .name = "fnd_task",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
/**
* @brief Function implementing the stepmotor_task thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the fnd_task thread.
* @param argument: Not used
* @retval None
*/
